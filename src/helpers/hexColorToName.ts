// https://github.com/jeff3754/HexColorToColorName#readme

export const GetColorName = (code: string) => {
    const colorToNameConvertor = new HexCodeToColorName();
    const name = colorToNameConvertor.name(code);
...
class HexCodeToColorName {
    ...
    private names: any[] = [
        ...
        ["211A0E", "Eternity"],
        ["220878", "Deep Blue"],
        ["228B22", "Forest Green"],["232323","Black"],
        ["233418", "Mallard"],
        ["240A40", "Violet"],
        ["240C02", "Kilamanjaro"],
        ["242A1D", "Log Cabin"],
    ...
    private hsl(color: string) {
        const [r, g, b] = [parseInt(`0x${color.substring(1, 3)}`) / 255, parseInt(`0x${color.substring(3, 5)}`) / 255, parseInt(`0x${color.substring(5, 7)}`) / 255];
